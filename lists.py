...
# literal
person = {"name": "Steve", "age": 24}  # dictionaray
people = ("andrew", "Jon", "Mike")  # tuple
...
a = fruits[0]
b = fruits[0:2]  # [0,2)
c = fruits[::3]  # 3 ta qadam tashlaydi
d = fruits[::-1]  # teskari tartiblab beradi
...
print("new_car1", new_cars)

result_app = map(lambda car: car[0], cars)
new_cars = list(result_app)
